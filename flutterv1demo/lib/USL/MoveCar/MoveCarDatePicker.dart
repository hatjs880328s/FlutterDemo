...
/// 创建两个picker
          ...
          builder: (BuildContext context) {
            return _buildBottomPicker(
                ...
                CupertinoPicker(
                  ...
                  children:
                    List<Widget>.generate(cityInfos[_selectedColorIndex].length, (int index) {
                    return Center(
                      child: Text(cityInfos[_selectedColorIndex][index].toString()),
                    );
                  }),
                ));
          },
  ...
  Widget build(BuildContext context) {
    return Container(
      color: _selectedColorIndex == 0 ? Colors.yellow : Colors.red,
